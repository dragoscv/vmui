...
export function Pc() {
  ...
  React.useEffect(() => {
    if (!mobile) void isEnabled().then(setAuto).catch(() => setAuto(null));
  ...
  return (
    <div className="grid gap-5">
      <div>
        ...
        <p className="text-sm text-muted mt-1">{mobile ? "Comenzile ajung la PC prin Pi (MQTT), când e pornit. Verbe fixe, nimic arbitrar." : "Aceleași verbe fixe ca în scripts/pc-action.ps1 — nimic arbitrar."}</p>
      </div>
