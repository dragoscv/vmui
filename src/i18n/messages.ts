...
export const NAMESPACES = ["homeCards", "notify", "nutrition", "ambilight", "turzx", "nestHub", "devices", "family", "shell", "appearance", "vm", "dashboard", "settings", "auth", "misc", "cloud", "ops", "observe", "govern", "extras"] as const;
